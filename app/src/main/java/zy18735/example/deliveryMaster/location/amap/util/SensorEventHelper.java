package zy18735.example.deliveryMaster.location.amap.util;
...
/**
 * This class is copy from Amap's official demo project. No Edit. Original Version.
 *
 * See https://lbs.amap.com/api/android-sdk/download
 */
